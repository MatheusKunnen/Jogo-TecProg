...
const float NarcotraficanteDesmatador::ATTACK_DISTANCE(640.f);
const float NarcotraficanteDesmatador::VEL_PROJETIL(6.f);
...
Atirador(position, texture, jogador_a, jogador_b, fase, NarcotraficanteDesmatador::VEL_PROJETIL, NarcotraficanteDesmatador::DAMAGE)
{
